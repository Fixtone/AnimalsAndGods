...
#define DOT_SCENELOADER_H
	...
	class DotSceneLoader
	{
		...
		protected:
			...
			void processEntity(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pParent, Ogre::int32 aId);
			...
			void processNodeUserData(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pParent, Ogre::int32 aNodeId);
			void processLightUserData(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pParent, Ogre::String aLightName, Ogre::int32 aNodeId, Ogre::Light::LightTypes aType, bool aVisible,
			...
			void processNodeEntityUserData(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pParent);
			void processUserDataProperty(rapidxml::xml_node<>* XMLNode);
		...
		private:
			...
			void _mySplit(std::vector<Ogre::String> &tokens, const Ogre::String &text, char sep);
			std::vector<Ogre::Real> parseStringLodDistance(Ogre::String aDistanceLods);
			
			Ogre::Entity* _createEntity(Ogre::SceneNode* aSceneNode, Ogre::String aName, Ogre::String aMeshFile, Ogre::String aMaterialFile, 
										bool aCastShadows = false, bool createLODs = false);			
